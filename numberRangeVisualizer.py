...
with open(('./DATA/{}').format(matrix_file_name), 'w') as f1, open(('./DATA/{}').format(label_matrix_file_name), 'w') as f2:
...
data = np.genfromtxt(("./DATA/{}").format(matrix_file_name), dtype=str, encoding=None, delimiter=",")
harvest = data
vegetables = tuple(np.arange(1, (x_axis_count + 1), 1, dtype=int))
farmers = tuple(np.arange(1, (y_axis_count + 1), 1, dtype=int))
z_text = np.genfromtxt(("./DATA/{}").format(label_matrix_file_name), dtype=str, encoding=None, delimiter=",")
